<?php $__env->startSection('content'); ?>
  <link rel="stylesheet" href="<?php echo e(config('url')); ?>/com/jQuery-File-Upload-9.9.3/css/jquery.fileupload.css">
...
<script charset="utf-8" src="<?php echo e(config('url')); ?>/com/kindeditor/kindeditor.js"></script>
<script charset="utf-8" src="<?php echo e(config('url')); ?>/com/kindeditor/lang/zh_CN.js"></script>
...
<script src="<?php echo e(config('url')); ?>/com/jQuery-File-Upload-9.9.3/js/vendor/jquery.ui.widget.js"></script>
<script src="<?php echo e(config('url')); ?>/com/jQuery-File-Upload-9.9.3/js/load-image.all.min.js"></script>
<script src="<?php echo e(config('url')); ?>/com/jQuery-File-Upload-9.9.3/js/canvas-to-blob.min.js"></script>
<script src="<?php echo e(config('url')); ?>/com/jQuery-File-Upload-9.9.3/js/jquery.iframe-transport.js"></script>
<script src="<?php echo e(config('url')); ?>/com/jQuery-File-Upload-9.9.3/js/jquery.fileupload.js"></script>
<script src="<?php echo e(config('url')); ?>/com/jQuery-File-Upload-9.9.3/js/jquery.fileupload-process.js"></script>
<script src="<?php echo e(config('url')); ?>/com/jQuery-File-Upload-9.9.3/js/jquery.fileupload-image.js"></script>
<script type="text/javascript">
$(function(){
